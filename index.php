...
$totalResult  = $conn->query($totalPostSql);

$totalPost    = $totalResult->fetch_array(MYSQLI_NUM)[0];
$totalPage    = ceil($totalPost/$postPerPage);

//Post Query

$sqlP = "SELECT * FROM post WHERE status='publish' LIMIT {$offset}, {$postPerPage}";
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-9 mx-auto">
        <h1 class="mb-5"><?php echo getSValue('homeheader'); ?></h1>
        <ul class="list-inline widget-list-inline">
          <?php while($category = $resultC->fetch_assoc()) {
              echo "<li class='list-inline-item'><a href='category.php?name=".$category['slug']."'>".$category['name']."</a></li>";
          } ?>
        </ul>
      </div>
    </div>
...
<section class="section-sm">
  ...
  <div class="post-slider">
      <img src="blog-admin/postimage/<?php echo $post['filename']; ?>" class="card-img-top" alt="post-thumb">
  </div>
  <div class="card-body">
      <h3 class="mb-3"><a class="post-title" href="<?php echo $post['slug'];?>"><?php echo $post['title']; ?></a></h3>
      <ul class="card-meta list-inline">
      <li class="list-inline-item">
          <a href="author-single.html" class="card-meta-author">
      ...
      <?php echo limit_text(stripslashes($post['content']), 30);?>
